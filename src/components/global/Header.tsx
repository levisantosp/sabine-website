    ...
    <>
      <header className='bg-[#0d763e] shadow-xl p-2 md:px-10'>
        <div className='hidden md:flex items-center justify-between'>
          ...
          <ul className='flex flex-wrap items-center justify-end gap-4 text-base/6 mt-2 sm:mt-0'>
            <li className='transition duration-300 hover:scale-105'>
              <Link
                href='/invite'
                className='inline-block py-1 sm:py-2 px-2 sm:px-4 bg-[#3442b8] text-white rounded-md'
                target='_blank'
              >
            ...
            <li className='transition duration-300 hover:scale-105'>
              <Link
                href='/commands'
                className='flex gap-2 inline-block py-1 sm:py-2 px-2 sm:px-4 bg-[#0d763e] text-white rounded-md hover:bg-[#11924b] transition'
              >
                <div className='flex gap-2'>
                  <Bot />
                  {t('header.commands')}
